...
//		bt.insert(i);
	...
	/**
	 * Sucht nach dem gegebenen Schlï¿½ssel im Baum. Ist der Schlï¿½ssel im Baum enthalten, wird 
	...
	/**
	 * Fuegt einen Schlï¿½ssel ein, sofern der noch nicht im Baum enthalten ist
	 * @param c
	...
	public int getMax() {
			if(this.wurzel == null)
				println("Der Baum ist leer, und hat somit kein höchstes Element.")
